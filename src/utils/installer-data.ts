...
const WORKFLOW_CONFIGS: WorkflowConfig[] = [
  ...
  cmd('opencode-exec', 2.55, 'development', 'OpenCode 全权执行', 'OpenCode Ultrawork', '使用 opencode-codex-orch 的 ultrawork 模式进行完全自动化执行', 'Fully automated execution using opencode-codex-orch ultrawork mode'),
  cmd('opencode-workflow', 2.56, 'development', 'OpenCode 多Agent工作流', 'OpenCode Multi-Agent Workflow', '使用 opencode-codex-orch 进行全自动化任务执行', 'Fully automated task execution using opencode-codex-orch'),
